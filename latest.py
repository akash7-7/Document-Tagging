...
tfid = TfidfVectorizer(norm="l2",max_features=100,stop_words = 'english',lowercase=True, ngram_range=(1, 3)) 
...
for i in range(len(places)):
	...
	nb_match = nb_match + difflib.SequenceMatcher(None,knn_places[i],places[i]).ratio()
	rf_match = rf_match + difflib.SequenceMatcher(None,svm_places[i],places[i]).ratio()
